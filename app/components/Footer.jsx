      ...
      <div className="flex flex-wrap gap-y-10 md:justify-center md:items-center">
        <div className="md:w-1/2">
          ...
          <div className="mt-10 w-fit">
            <p className="text-lg md:text-xl">Social Media</p>
            <div className="flex gap-5 mt-2">
              <Link
                target="_blank"
                href="https://api.whatsapp.com/send?phone=6285876048549&text=hello!%20I%27d%20like%20to%20get%20one%20of%20the%20product%20you%20offer.%20How%20could%20I%20buy%20it%3F"
              >
                <svg
              ...
              <Link
                href="https://instagram.com/faiqpramatya?igshid=MzMyNGUyNmU2YQ=="
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
