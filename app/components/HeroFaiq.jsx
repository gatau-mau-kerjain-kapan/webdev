...
export default function HeroFaiq() {
  return (
    <>
      <div
        id="main-section"
        className="w-[99vw] mt-20 relative h-[500px] lg:h-screen flex items-center justify-center lg:justify-start bg-[url(/asset_mainpage/coffee-beans-with-props-making-coffee.jpg)] lg:bg-[url(/asset_mainpage/coffee-beans-with-props-making-coffee.jpg)] lg:bg-cover bg-no-repeat bg-center"
      >
        <div
        ...
        <div className="h-fit lg:ms-24 z-10 flex flex-col justify-start">
          <div className="text-left montserrat text-[#f1dec9] lg:text-5xl text-lg font-semibold mb-1">
            Hi fellas! Welcome to
          </div>
          <div className="text-start montserrat text-[#facb8a] font-semibold lg:text-8xl text-5xl mb-1">
            Beanmaster
          </div>
          <div className="text-left montserrat text-[#f1dec9] lg:text-2xl font-semibold">
