...
export default function HeroFaiq() {
  return (
    <>
      <div
        id="main-section"
        className="w-[99vw] relative h-[500px] lg:h-screen flex items-center justify-center lg:justify-start bg-[url(/asset_mainpage/coffee-beans-with-props-making-coffee.jpg)] lg:bg-[url(/asset_mainpage/coffee-beans-with-props-making-coffee.jpg)] lg:bg-cover bg-no-repeat bg-center"
      >
        <div
