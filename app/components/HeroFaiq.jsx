...
export default function HeroFaiq() {
    ...
    <>
      ...
      >
        ...
        <div>
          <h1 className="text-left montserrat text-[#f1dec9] lg:text-5xl text-lg mb-1">
            Hi fellas! Welcome to
          </h1>
          </div>
          <div>
          <h1 className="text-start montserrat text-[#facb8a] font-semibold lg:text-8xl text-5xl mb-1">
            Beanmaster
          </h1>
          </div>
          <div>
          <h1 className="text-left montserrat text-[#f1dec9] lg:text-2xl">
