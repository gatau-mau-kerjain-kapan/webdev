    ...
    return (
        ...
        <div class="bg-gray-100 pt-20 pb-20">
            ...
            <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                ...
                <p class="text-gray-700">{total.toLocaleString('id', {style: 'currency', currency: 'IDR'})}</p>
                </div>
                <div class="flex justify-between">
                <p class="text-gray-700">Shipping</p>
                <p class="text-gray-700">{shipping.toLocaleString('id', {style: 'currency', currency: 'IDR'})}</p>
                </div>
                <hr class="my-4" />
                <div class="flex justify-between">
                <p class="text-lg font-bold">Total</p>
                <div class="">
                    <p class="mb-1 text-lg font-bold">{(total + shipping).toLocaleString('id', {style: 'currency', currency: 'IDR'})}</p>
                    ...
                    <Container>
                        <div className="h-[40vh] flex justify-center items-center p">
                            <div className="text-center">
                                ...
                                <Link className="mt-2 rounded-md bg-blue-500 px-20 py-1.5 font-medium text-blue-50 hover:bg-blue-600" href="/ProdDetails">Go Shopping</Link>
                            </div>
                        </div>
                    </Container>
                    </>
